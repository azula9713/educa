...
export const StudentLogin: React.FC<RouteComponentProps> = ({ history }) => {
        ...
        <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                history.push("/student-dashbaord");
              } catch (err) {
          ...
          <div className="text-center pt-12 pb-12">
            <p>
              ...
              <Link to="student-register" className="underline font-semibold">
                Register here.
              </Link>
            </p>
          </div>
